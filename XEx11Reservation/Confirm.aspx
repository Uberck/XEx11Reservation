    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <asp:Button ID="btnModify" runat="server" Text="Modify Request" 
                CssClass="btn btn-primary" PostBackUrl="~/Request" /> <!-- change the PostBackUrl property of the Modify Request button so the page it refers to no longer has a file extension -->
        </div>
    </div>
